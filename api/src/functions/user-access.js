            ...
            if (employeeId) {
                ...
                if (result.recordset.length === 0) {
                    ...
                    return ok({
                        ...
                        invoicing: false, afps: false, reconcile: false, estimating_dashboard: false
                    }, request);
                }
    ...
    handler: async (request, context) => {
        ...
        try {
            ...
            const permCols = [
                ...
                'invoicing', 'afps', 'reconcile', 'estimating_dashboard'
            ];
            ...
            const keyMap = {
                ...
                invoicing: 'invoicing', afps: 'afps', reconcile: 'reconcile', estimatingDashboard: 'estimating_dashboard'
            };
